...
# output file name
# ------------------------------------------------
fout_name = "out_reach_WIMP_default"


# ------------------------------------------------
# parameter block for sample and read-out info
# ------------------------------------------------
sample_age_Myr = 1000.0  # age of the target sample in [Myr]
sample_mass_kg = 1e-5  # mass of the target sample in [kg]
readout_resolution_Aa = 10.0  # track length resolution in [Ångström]
C238 = 1e-11  # uranium-238 concentration per weight in [g/g]
mineral_name = "Sinjarite"  # name of the target mineral.
...
#  rel_bkg_sys = 0. # optional parameter to include systematic error on the number of background events / bin
