...
# for use in tests
# ------------------------------------------------
Atmos_neutrino_background = False
DSNB_background = False
GSNB_background = False
Solar_neutrino_background = False
Neutron_background = False
SingleAlpha_background = False
