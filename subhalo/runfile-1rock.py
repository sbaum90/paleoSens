# 1 rock of age 1000 Myr (with same total exposure as fiducial case)
# ------------------------------------------------
# Output file name
# ------------------------------------------------
...
Youngest_sample_age = 1000  # Age of the youngest rock sample in Myr
...
Sample_mass = 0.3  # Mass of each rock sample in kg
