# Does not optimize over mass (i.e. fixes it to fiducial value with no external constraints)
# ------------------------------------------------
# Output file name
# ------------------------------------------------
Output = "result-nomassopt.txt"
...
# ------------------------------------------------
Optimize_mass = False # Treat mass as nuisance parameter (if False, mass is fixed to fiducial value)
