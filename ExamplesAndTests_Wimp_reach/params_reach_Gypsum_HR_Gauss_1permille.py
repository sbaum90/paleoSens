...
# output file name
# ------------------------------------------------
fout_name = "ExamplesAndTests_Wimp_reach/reach_HR_Gauss_1permille"
...
rel_bkg_sys = 1e-3 # optional parameter to include systematic error on the number of background events / bin
