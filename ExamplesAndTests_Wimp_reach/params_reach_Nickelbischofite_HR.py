...
# output file name
# ------------------------------------------------
fout_name = "ExamplesAndTests_Wimp_reach/reach_HR"
...
C238 = 1e-10  # uranium-238 concentration per weight in [g/g]
mineral_name = "Nickelbischofite"  # name of the target mineral.
