...
# output file name
# ------------------------------------------------
fout_name = "ExamplesAndTests_Wimp_reach/reach_HR_Gauss_10permille"
...
rel_bkg_sys = 1e-2 # optional parameter to include systematic error on the number of background events / bin
