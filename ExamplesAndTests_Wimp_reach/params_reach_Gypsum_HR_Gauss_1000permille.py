...
# output file name
# ------------------------------------------------
fout_name = "ExamplesAndTests_Wimp_reach/reach_HR_Gauss_1000permille"
...
DMmass_max_GeV = 5e4  # largest DM mass in [GeV] for which the limit is computed
...
rel_bkg_sys = 1. # optional parameter to include systematic error on the number of background events / bin
